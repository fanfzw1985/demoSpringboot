...
function checkesed(){
	...
	var to=document.getElementById("formId");
	 	to.action="/account/accountAdd2.action?flag=1";
   		to.submit();
	return true;}
	}	
</script>  
...
<body>
<form action="/account/accountAdd.action?flag=1" method="post" id="formId" name="formName">
<div>日常收入</div>
<table>
	<tr><td colspan="2" style="text-align:center;"><a href="/jsp/account1.jsp"><input type="button"  value="日常收入"   /></a></td>
	<td colspan="2" style="text-align:center;"><a href="/jsp/account2.jsp"><input type="button"  value="日常支出" /></a></td></tr>
	<tr><td>&nbsp;</td> </tr>
