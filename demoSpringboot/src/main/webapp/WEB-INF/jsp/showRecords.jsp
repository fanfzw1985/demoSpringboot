...
<form action="/messageBoard/updateBoardById.action?id=${records.id }&flag=${records.flag}" method="post">
请输入留言内容：（至少输入六位留言内容）<br/><textarea id="messageBoardUpdate" rows="16" cols="40" STYLE="font-size:15pt;font-family:verdana" name="messageBoardUpdate" onfocus="if (value =='请输入内容：'){value='';}" onblur="if (value ==''){value='请输入内容：';}">${records.message }</textarea><br/><br/>
...
<a href="/messageBoard/showMessageBoard.action?flag=${records.flag}"><input type="button" value="取消修改"></a>
</form>
</center>
</body>
</html>